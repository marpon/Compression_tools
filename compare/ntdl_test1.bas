'ntdl_test1.bas to test Rtl ntdll code
...
#define _MY_INPUT_			"blabla.txt"					' input file name
#define _MY_COMPRESS_		"blabla_txt.press"				' compressed file name
#define _MY_DECOMPRESS_		"blabla__dec_txt"				' decompressed file name
'==================================================
